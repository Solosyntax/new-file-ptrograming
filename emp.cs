...
/*emp.Name.Star;
                       if (ENAME.Length == 1 & ENAME[0] == emp.Name[0]) { Console.WriteLine("|" + emp.Name + "---" + emp.ID + "|"); Options(); }
                       else if (ENAME.Length == emp.Name.Length || ENAME.Length < emp.Name.Length)
                       {
                           int k = 1;
                           while(ENAME[w + k] == emp.Name[w + k])
                           Console.WriteLine("|" + emp.Name + "---" + emp.ID + "|");
                       } 
                       else { Console.WriteLine("--searching--"); }


                          // Console.WriteLine("|" + emp.Name + "---" + emp.ID + "|" + i + w + x);
                           //else { Console.WriteLine("----"); }
                   }

               //return null;
               //&(ENAME[w + 1] == emp.Name[x + 1]) & (ENAME[w + 2] == emp.Name[w + 2])

           }
           FindEmployeeByName(ENAME, 1);
           return null;*/
                ...
                if (emp.Name == ENAME)
                {
                    ...
                    //{
                        ...
                        //{
                            ...
                            //break;
                            //else if (emp.Name[i] == String.Contai) { }
                        //}   //else if (emp.Name[i] == String.Contai) { }
                    //}
                }
                //break;
...
15:29
   //here:
                    ...
                    //for(i = 0; i < emp.Name.Length; i++) //EMPNAME 
                    //{
                    //int count = 1;
                    //for(i = 0; i < ENAME.Length; i++)
                    //{
                    while (ENAME[i] == emp.Name[i])
                            {
                        i = i + 1;
                        return emp;
                        
                               // Console.WriteLine(" test - 1 "  + i + ENAME[i] + emp.Name[i]);
                            }
